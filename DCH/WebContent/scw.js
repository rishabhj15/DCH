...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwInvalidDateMsg      = 'Date non valide\n';
             scwOutOfRangeMsg       = 'La date saisie est hors de portée.';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #0079ff;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwCellsExMonth         {background-color:  #67666a;'   +
                                        'color:             #CCCCCC;}'  +
            '/* Today selector */'                                      +

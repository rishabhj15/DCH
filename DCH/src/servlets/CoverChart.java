...
public class CoverChart extends HttpServlet {
      ...
      try {
            ...
            try {
                            ...
                            ResultSet rs=st.executeQuery("Select * from covtype");
            ...
            dataset.setValue(rs.getInt("quantity"), "Available", rs.getInt("id")+" "+rs.getString("name"));
                }else{
                dataset.setValue(rs.getInt("quantity"), "Short", rs.getInt("id")+" "+rs.getString("name"));
                }
                }
